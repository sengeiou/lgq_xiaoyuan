...
Source Database       : xiaoyuan

Target Server Type    : MYSQL
Target Server Version : 50725
File Encoding         : 65001

Date: 2019-02-25 14:48:38
*/
...
-- ----------------------------
INSERT INTO `family_base_info` VALUES ('1', 'a', 'cc', '58ce9b60004d7dec736f33edc725e4db', 'test', '0', '25', '18538062907', '0', '0', '1', '2015-12-06 13:14:05', null, '86521760@qq.com');
...
-- ----------------------------
-- Table structure for matter_warn
-- ----------------------------
DROP TABLE IF EXISTS `matter_warn`;
CREATE TABLE `matter_warn` (
  `id` bigint(60) NOT NULL AUTO_INCREMENT,
  `matter` varchar(200) DEFAULT NULL COMMENT '备注',
  `begin_time` datetime DEFAULT NULL COMMENT '开始时间',
  `end_time` datetime DEFAULT NULL COMMENT '结束时间',
  `user_id` bigint(30) DEFAULT NULL COMMENT '用户id',
  `start_using` varchar(2) DEFAULT NULL COMMENT '启用状态 0为不启用，1为启用',
  `warn_time` date DEFAULT NULL COMMENT '提醒时间',
  `remark` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='这是重要时间提醒表';

-- ----------------------------
-- Records of matter_warn
-- ----------------------------
INSERT INTO `matter_warn` VALUES ('1', 'matter', '2019-02-19 14:34:51', '2019-02-07 14:34:55', '1812120000000000', '1', '2019-03-07', 'beizhu');
INSERT INTO `matter_warn` VALUES ('2', 'matter', '2019-02-19 14:34:51', '2019-02-07 14:34:55', '1812120000000020', '1', '2019-02-21', 'beizhu');
INSERT INTO `matter_warn` VALUES ('3', 'matter', '2019-02-19 14:34:51', '2019-02-07 14:34:55', '1812120000000000', '0', '2019-02-21', 'beizhu');
INSERT INTO `matter_warn` VALUES ('4', '1515', null, null, '1812120000000000', '1', '2019-02-23', '你要结婚了，恭喜你');
...
-- ----------------------------
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'USER-20180811DJ1550970488612', '1551017495325', '15000');
...
-- ----------------------------
INSERT INTO `sys_cost_time` VALUES ('1902182157290000', 'com.project.web.controller.modules.EcharsAction', 'echarts4()', '5405');
INSERT INTO `sys_cost_time` VALUES ('1902182230050000', 'com.project.web.controller.modules.EcharsAction', 'loop()', '14960');
INSERT INTO `sys_cost_time` VALUES ('1902191124100000', 'com.project.web.controller.modules.MyTestController', 'sendMail()', '1309');
INSERT INTO `sys_cost_time` VALUES ('1902191139190000', 'com.project.web.controller.modules.MyTestController', 'sendAttMail()', '1789');
INSERT INTO `sys_cost_time` VALUES ('1902191141220000', 'com.project.web.controller.modules.MyTestController', 'sendAttMail()', '636');
INSERT INTO `sys_cost_time` VALUES ('1902191146510000', 'com.project.web.controller.modules.MyTestController', 'sendAttMail()', '1298');
INSERT INTO `sys_cost_time` VALUES ('1902191222050000', 'com.project.web.controller.modules.MyTestController', 'sendTempleHtmlMail()', '2141');
INSERT INTO `sys_cost_time` VALUES ('1902191233580000', 'com.project.web.controller.modules.MyTestController', 'sendImgMail()', '2047');
INSERT INTO `sys_cost_time` VALUES ('1902201415430001', 'com.project.web.controller.system.IndexController', 'main()', '618');
INSERT INTO `sys_cost_time` VALUES ('1902201451510001', 'com.project.web.controller.system.IndexController', 'index()', '3206');
INSERT INTO `sys_cost_time` VALUES ('1902201452030002', 'com.project.web.controller.system.IndexController', 'index()', '3555');
INSERT INTO `sys_cost_time` VALUES ('1902201538270000', 'com.project.web.controller.modules.WarnController', 'warn()', '4775');
INSERT INTO `sys_cost_time` VALUES ('1902201813230000', 'com.project.web.controller.modules.MyTestController', 'GetDepartment()', '23434');
INSERT INTO `sys_cost_time` VALUES ('1902201814260001', 'com.project.web.controller.modules.MyTestController', 'GetDepartment()', '21822');
INSERT INTO `sys_cost_time` VALUES ('1902201815280002', 'com.project.web.controller.modules.MyTestController', 'GetDepartment()', '48389');
INSERT INTO `sys_cost_time` VALUES ('1902231533210005', 'com.project.web.controller.system.UserController', 'addSave()', '93261');
INSERT INTO `sys_cost_time` VALUES ('1902231554260009', 'com.project.web.controller.modules.WarnController', 'list()', '36874');
INSERT INTO `sys_cost_time` VALUES ('1902231557290010', 'com.project.web.controller.system.ProfileController', 'profile()', '177334');
INSERT INTO `sys_cost_time` VALUES ('1902231557290011', 'com.project.web.controller.system.ProfileController', 'profile()', '1718');
INSERT INTO `sys_cost_time` VALUES ('1902231600160000', 'com.project.web.controller.system.ProfileController', 'profile()', '12969');
INSERT INTO `sys_cost_time` VALUES ('1902231602180002', 'com.project.web.controller.system.ProfileController', 'profile()', '43492');
INSERT INTO `sys_cost_time` VALUES ('1902232147010001', 'com.project.web.controller.system.LoginController', 'ajaxLogin()', '7223');
...
INSERT INTO `sys_dept` VALUES ('1812121212120001', '1812121212120000', '100100', '默认', '1', '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
INSERT INTO `sys_dept` VALUES ('1812121212120002', '1812121212120000', '100101', '第一分组', '2', '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
...
INSERT INTO `sys_logininfor` VALUES ('1902181743080000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-18 17:43:07');
INSERT INTO `sys_logininfor` VALUES ('1902181747560000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-18 17:47:55');
INSERT INTO `sys_logininfor` VALUES ('1902181751330000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-18 17:51:32');
INSERT INTO `sys_logininfor` VALUES ('1902182110300000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-18 21:10:30');
INSERT INTO `sys_logininfor` VALUES ('1902182133100000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '0', '登录成功', '2019-02-18 21:33:10');
INSERT INTO `sys_logininfor` VALUES ('1902182153450000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-18 21:53:45');
INSERT INTO `sys_logininfor` VALUES ('1902191315340000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-19 13:15:33');
INSERT INTO `sys_logininfor` VALUES ('1902191323450002', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '1', '密码输入错误1次', '2019-02-19 13:23:44');
INSERT INTO `sys_logininfor` VALUES ('1902191323540003', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '1', '密码输入错误2次', '2019-02-19 13:23:52');
INSERT INTO `sys_logininfor` VALUES ('1902191323570004', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '1', '密码输入错误3次', '2019-02-19 13:23:56');
INSERT INTO `sys_logininfor` VALUES ('1902191324210005', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '1', '密码输入错误4次', '2019-02-19 13:24:19');
INSERT INTO `sys_logininfor` VALUES ('1902191324270006', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '0', '登录成功', '2019-02-19 13:24:26');
INSERT INTO `sys_logininfor` VALUES ('1902191831550000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Internet Explorer 9', 'Windows 7', '0', '登录成功', '2019-02-19 18:31:54');
INSERT INTO `sys_logininfor` VALUES ('1902201358220000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 13:58:20');
INSERT INTO `sys_logininfor` VALUES ('1902201433540000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 14:33:52');
INSERT INTO `sys_logininfor` VALUES ('1902201446100000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 14:46:08');
INSERT INTO `sys_logininfor` VALUES ('1902201601360000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '退出成功', '2019-02-20 16:01:34');
INSERT INTO `sys_logininfor` VALUES ('1902201601380001', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 16:01:36');
INSERT INTO `sys_logininfor` VALUES ('1902201602440000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 16:02:42');
INSERT INTO `sys_logininfor` VALUES ('1902201610400000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 16:10:38');
INSERT INTO `sys_logininfor` VALUES ('1902201705460001', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-20 17:05:44');
INSERT INTO `sys_logininfor` VALUES ('1902210930460000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-21 09:30:44');
INSERT INTO `sys_logininfor` VALUES ('1902231431550000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 14:31:51');
INSERT INTO `sys_logininfor` VALUES ('1902231507030000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 15:07:00');
INSERT INTO `sys_logininfor` VALUES ('1902231530540003', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 15:30:50');
INSERT INTO `sys_logininfor` VALUES ('1902231537400008', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '退出成功', '2019-02-23 15:37:36');
INSERT INTO `sys_logininfor` VALUES ('1902231545500000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 15:45:47');
INSERT INTO `sys_logininfor` VALUES ('1902231546560001', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '1', '密码输入错误1次', '2019-02-23 15:46:53');
INSERT INTO `sys_logininfor` VALUES ('1902231547040002', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '1', '密码输入错误2次', '2019-02-23 15:47:00');
INSERT INTO `sys_logininfor` VALUES ('1902231547090003', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '1', '密码输入错误3次', '2019-02-23 15:47:06');
INSERT INTO `sys_logininfor` VALUES ('1902231547220004', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '1', '密码输入错误4次', '2019-02-23 15:47:18');
INSERT INTO `sys_logininfor` VALUES ('1902231547310005', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 15:47:28');
INSERT INTO `sys_logininfor` VALUES ('1902231548060006', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '退出成功', '2019-02-23 15:48:02');
INSERT INTO `sys_logininfor` VALUES ('1902231548100007', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 15:48:06');
INSERT INTO `sys_logininfor` VALUES ('1902231550410008', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Downloading Tool', 'Unknown', '0', '登录成功', '2019-02-23 15:50:37');
INSERT INTO `sys_logininfor` VALUES ('1902231601320001', 'admin', '1812121212120000', '192.168.11.215', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 16:01:28');
INSERT INTO `sys_logininfor` VALUES ('1902231701190000', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:01:15');
INSERT INTO `sys_logininfor` VALUES ('1902231702190001', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:02:15');
INSERT INTO `sys_logininfor` VALUES ('1902231706020002', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:05:59');
INSERT INTO `sys_logininfor` VALUES ('1902231711460000', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:11:42');
INSERT INTO `sys_logininfor` VALUES ('1902231714440000', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:14:40');
INSERT INTO `sys_logininfor` VALUES ('1902231717290001', 'admin', '1812121212120000', '192.168.11.155', 'XX XX', 'Mobile Safari', 'Mac OS X (iPhone)', '0', '登录成功', '2019-02-23 17:17:25');
INSERT INTO `sys_logininfor` VALUES ('1902232146560000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Firefox', 'Windows 7', '0', '登录成功', '2019-02-23 21:47:00');
INSERT INTO `sys_logininfor` VALUES ('1902240956380000', 'admin', '1812121212120000', '127.0.0.1', 'XX XX', 'Chrome', 'Windows 7', '0', '登录成功', '2019-02-24 09:56:26');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('1', '系统管理', '0', '8', '#', 'M', '0', '', 'fa fa-gear', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '系统管理目录');
INSERT INTO `sys_menu` VALUES ('2', '系统监控', '0', '9', '#', 'M', '0', '', 'fa fa-video-camera', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '系统监控目录');
INSERT INTO `sys_menu` VALUES ('3', '系统工具', '0', '10', '#', 'M', '0', '', 'fa fa-bars', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '系统工具目录');
INSERT INTO `sys_menu` VALUES ('4', '家族族谱', '0', '1', '#', 'M', '0', '', 'fa fa-gear', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '家族谱目录');
INSERT INTO `sys_menu` VALUES ('5', '事项提醒', '0', '5', '#', 'M', '0', '', 'fa fa-gear', 'admin', '2018-03-01 00:00:00', 'lugongqi', '2018-03-01 00:00:00', '这是重要时间提醒菜单');
...
INSERT INTO `sys_menu` VALUES ('511', '重大事项', '5', '1', '/warn', 'C', '0', 'family:baseinfo:add', '#', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '重大事项');
INSERT INTO `sys_menu` VALUES ('512', '发送邮件', '5', '2', '/warn/', 'C', '0', 'family:apply:homeman', '#', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '发送邮件');
INSERT INTO `sys_menu` VALUES ('513', '发送短信', '5', '3', '/warn/', 'C', '0', 'family:apply:homeman', '#', 'admin', '2018-03-16 11:33:00', 'lugongqi', '2018-03-16 11:33:00', '发送短信');
...
INSERT INTO `sys_menu` VALUES ('2005', '事项提醒查询', '5', '1', '#', 'F', '0', 'com:warn:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2006', '事项提醒新增', '5', '2', '#', 'F', '0', 'com:warn:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2007', '事项提醒修改', '5', '3', '#', 'F', '0', 'com:warn:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES ('2008', '事项提醒删除', '5', '4', '#', 'F', '0', 'com:warn:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
...
INSERT INTO `sys_oper_log` VALUES ('1902181743320001', '个人信息', '2', 'com.project.web.controller.system.ProfileController.updateAvatar()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/profile/updateAvatar', '127.0.0.1', 'XX XX', '{  \"userId\" : [ \"1812120000000000\" ]}', '0', null, '2019-02-18 17:43:31');
INSERT INTO `sys_oper_log` VALUES ('1902181801440001', '代码生成', '8', 'com.project.web.controller.tool.GenController.genCode()', '1', 'admin', '1812121212120000', '笑缘项目', '/tool/gen/genCode/matter_warn', '127.0.0.1', 'XX XX', '{ }', '0', null, '2019-02-18 18:01:43');
INSERT INTO `sys_oper_log` VALUES ('1902181814580002', '角色管理', '2', 'com.project.web.controller.system.RoleController.editSave()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/role/edit', '127.0.0.1', 'XX XX', '{  \"roleId\" : [ \"1812120000000001\" ],  \"roleName\" : [ \"内置管理员\" ],  \"roleKey\" : [ \"admin\" ],  \"roleSort\" : [ \"1\" ],  \"status\" : [ \"0\" ],  \"remark\" : [ \"内置管理员\" ],  \"menuIds\" : [ \"5,2005,2006,2007,2008\" ]}', '0', null, '2019-02-18 18:14:57');
INSERT INTO `sys_oper_log` VALUES ('1902182111090001', '个人信息', '2', 'com.project.web.controller.system.ProfileController.updateAvatar()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/profile/updateAvatar', '127.0.0.1', 'XX XX', '{  \"userId\" : [ \"1812120000000000\" ]}', '0', null, '2019-02-18 21:11:09');
INSERT INTO `sys_oper_log` VALUES ('1902182257370000', '在线用户', '7', 'com.project.web.controller.monitor.UserOnlineController.batchForceLogout()', '1', 'admin', '1812121212120000', '笑缘项目', '/monitor/online/batchForceLogout', '127.0.0.1', 'XX XX', '{  \"ids[]\" : [ \"002de5b3-bfb9-4da2-b6d5-7074959b0c18\" ]}', '1', 'There is no session with id [002de5b3-bfb9-4da2-b6d5-7074959b0c18]', '2019-02-18 22:57:37');
INSERT INTO `sys_oper_log` VALUES ('1902182257430001', '在线用户', '7', 'com.project.web.controller.monitor.UserOnlineController.batchForceLogout()', '1', 'admin', '1812121212120000', '笑缘项目', '/monitor/online/batchForceLogout', '127.0.0.1', 'XX XX', '{  \"ids[]\" : [ \"8d7c5a02-682c-4693-8f5d-16794e8866ab\", \"002de5b3-bfb9-4da2-b6d5-7074959b0c18\", \"643b035f-5889-409e-bdca-689662e65fe8\", \"847f4ec3-44a7-46cf-81c7-c88fd79f493e\" ]}', '0', null, '2019-02-18 22:57:44');
INSERT INTO `sys_oper_log` VALUES ('1902191316510001', '个人信息', '2', 'com.project.web.controller.system.ProfileController.updateAvatar()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/profile/updateAvatar', '127.0.0.1', 'XX XX', '{  \"userId\" : [ \"1812120000000000\" ]}', '0', null, '2019-02-19 13:16:49');
INSERT INTO `sys_oper_log` VALUES ('1902231440500002', '用户管理', '1', 'com.project.web.controller.system.UserController.addSave()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/add', '127.0.0.1', 'XX XX', '{  \"deptId\" : [ \"1812121212120001\" ],  \"loginName\" : [ \"lu\" ],  \"userName\" : [ \"ddd\" ],  \"password\" : [ \"123456\" ],  \"email\" : [ \"\" ],  \"phonenumber\" : [ \"\" ],  \"sex\" : [ \"0\" ],  \"status\" : [ \"0\" ],  \"roleIds\" : [ \"\" ],  \"postIds\" : [ \"\" ]}', '0', null, '2019-02-23 14:40:47');
INSERT INTO `sys_oper_log` VALUES ('1902231441020003', '用户管理', '3', 'com.project.web.controller.system.UserController.remove()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/remove', '127.0.0.1', 'XX XX', '{  \"ids\" : [ \"1902231440500001\" ]}', '0', null, '2019-02-23 14:40:58');
INSERT INTO `sys_oper_log` VALUES ('1902231441390005', '用户管理', '1', 'com.project.web.controller.system.UserController.addSave()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/add', '127.0.0.1', 'XX XX', '{  \"deptId\" : [ \"1812121212120002\" ],  \"loginName\" : [ \"luu\" ],  \"userName\" : [ \"admin\" ],  \"password\" : [ \"123456\" ],  \"email\" : [ \"\" ],  \"phonenumber\" : [ \"\" ],  \"sex\" : [ \"0\" ],  \"status\" : [ \"0\" ],  \"roleIds\" : [ \"1812120000000001\" ],  \"postIds\" : [ \"', '0', null, '2019-02-23 14:41:35');
INSERT INTO `sys_oper_log` VALUES ('1902231533220006', '用户管理', '1', 'com.project.web.controller.system.UserController.addSave()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/add', '127.0.0.1', 'XX XX', '{  \"deptId\" : [ \"1812121212120002\" ],  \"loginName\" : [ \"15\" ],  \"userName\" : [ \"154\" ],  \"password\" : [ \"123456\" ],  \"email\" : [ \"\" ],  \"phonenumber\" : [ \"\" ],  \"sex\" : [ \"0\" ],  \"status\" : [ \"0\" ],  \"roleIds\" : [ \"\" ],  \"postIds\" : [ \"\" ]}', '0', null, '2019-02-23 15:33:18');
INSERT INTO `sys_oper_log` VALUES ('1902240957100001', '个人信息', '2', 'com.project.web.controller.system.ProfileController.updateAvatar()', '1', 'admin', '1812121212120000', '笑缘项目', '/system/user/profile/updateAvatar', '127.0.0.1', 'XX XX', '{  \"userId\" : [ \"1812120000000000\" ]}', '0', null, '2019-02-24 09:56:58');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1812120000000001', '内置管理员', 'admin', '1', '1', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2019-02-18 18:14:56', '内置管理员');
...
-- ----------------------------
INSERT INTO `sys_role_menu` VALUES ('1812120000000001', '5');
INSERT INTO `sys_role_menu` VALUES ('1812120000000001', '2005');
INSERT INTO `sys_role_menu` VALUES ('1812120000000001', '2006');
INSERT INTO `sys_role_menu` VALUES ('1812120000000001', '2007');
INSERT INTO `sys_role_menu` VALUES ('1812120000000001', '2008');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1812120000000000', '1812121212120000', 'admin', '笑缘', '00', '1192374211@qq.com', '15237867818', '1', 'd57f35ccf189460f5c6744e35922438b.jpg', '3d3e2e119996cedb7401025cced5c1b0', '111111', '0', '0', '127.0.0.1', '2019-02-24 09:56:38', 'admin', '2018-03-16 11:33:00', 'ry', '2019-02-24 09:56:57', '管理员');
...
INSERT INTO `sys_user` VALUES ('1902231440500001', '1812121212120001', 'lu', 'ddd', '00', '', '', '0', '', 'c86e6133053dfa5244e0406ac72bcfdf', '0c6f91', '0', '2', '', null, 'admin', '2019-02-23 14:40:46', '', null, '');
INSERT INTO `sys_user` VALUES ('1902231441380004', '1812121212120002', 'luu', 'admin', '00', '', '', '0', '', 'a1843a70693fdd18fdc85be611c9568b', 'b11e05', '0', '0', '', null, 'admin', '2019-02-23 14:41:34', '', null, '');
INSERT INTO `sys_user` VALUES ('1902231533210004', '1812121212120002', '15', '154', '00', '', '', '0', '', '5db18d05b337a1a484b82b621a43da39', '17ba53', '0', '0', '', null, 'admin', '2019-02-23 15:33:17', '', null, '');
...
INSERT INTO `sys_user_role` VALUES ('1902231441380004', '1812120000000001');
